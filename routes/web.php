...
use App\Livewire\Masters\Lqms\Detail as MastersLqmsDetail;
...
Route::middleware('auth')->group(function ()
{
    ...
    Route::prefix('masters/lqms')->group(function ()
    {
        ...
        Route::get('/{uuid}', MastersLqmsDetail::class)->name('masters.lqms.show');
    ...
    Route::prefix('masters/annexures')->group(function ()
    {
        ...
        Route::get('/{uuid}', \App\Livewire\Masters\Annexures\Detail::class)->name('masters.annexures.show');
    ...
    Route::prefix('masters/forms')->group(function ()
    {
        ...
        Route::get('/{uuid}', \App\Livewire\Masters\Forms\Detail::class)->name('masters.forms.show');
