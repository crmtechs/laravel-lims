...
class Forms_Master extends Model
{
    use HasUuids, SoftDeletes;

    protected $table = 'forms_masters';
    ...
    {
        return $this->belongsTo(Forms_Masters_Revision::class, 'forms_masters_revision_uuid', 'uuid');
    }

    public function revisions()
    {
        return $this->hasMany(Forms_Masters_Revision::class, 'forms_master_uuid', 'uuid');
    }
