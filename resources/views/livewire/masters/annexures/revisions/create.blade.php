        ...
        <form wire:submit="save">
            ...
            <div class="callout callout-primary bg-white rounded shadow-sm w-100 d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="btn-toolbar gap-2">
                    ...
                    <a href="{{ route('masters.annexures.show', $annexure->uuid) }}" wire:navigate class="btn btn-danger d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-control bg-light">{{ $annexure->document_name }}</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">{{ __('annexures_master.latest_revision') }}</label>
                                <div class="form-control bg-light">{{ $annexure->activeRevision?->revision ?: '-' }}</div>
                            </div>

                            <!-- Row 2: File Browse and Revision -->
                            <div class="col-md-6 mb-3">
                                <label for="file_name" class="form-label fw-bold">{{ __('annexures_master.file_browse') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="revision" class="form-label fw-bold">{{ __('annexures_master.revision') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="change_log" class="form-label fw-bold">{{ __('annexures_master.change_log') }} <span class="text-danger">*</span></label>
