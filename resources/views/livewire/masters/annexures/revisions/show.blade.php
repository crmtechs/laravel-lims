        ...
        <div class="container-fluid">
            ...
            <div class="callout callout-primary bg-white rounded shadow-sm w-100 d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="btn-toolbar gap-2">
                    <a href="{{ route('masters.annexures.show', $annexure->uuid) }}" wire:navigate class="btn btn-outline-secondary d-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control form-control-view bg-light">{{ $annexure->activeRevision?->revision ?: '-' }}</div>
                        </div>
                        ...
                        <!-- Row 3 -->
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">{{ __('annexures_master.change_log') }}</label>
                            <div class="form-control bg-light h-auto min-h-5rem">
                                {{ $revision->change_log ?: '' }}
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">{{ __('annexures_master.date_created') }}</label>
