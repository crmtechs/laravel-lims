@push('scripts')
<script src="{{ asset('js/masters/annexures/form.js') }}?v={{ filemtime(public_path('js/masters/annexures/form.js')) }}"></script>
@endpush
...
<form wire:submit.prevent="save">
    ...
    <div class="callout callout-primary bg-white rounded shadow-sm w-100 d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-toolbar gap-2">
            ...
            <a href="{{ route('masters.annexures') }}" wire:navigate class="btn btn-danger d-flex align-items-center">
