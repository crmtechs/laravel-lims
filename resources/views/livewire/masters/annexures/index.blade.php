                                    ...
                                    <th>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu shadow text-sm">
                                                <li><a class="dropdown-item" href="#" wire:click.prevent="selectPage">{{ __('global.select_this_page') }} ({{ $annexures->count() }})</a></li>
                                                <li><a class="dropdown-item" href="#" wire:click.prevent="selectAll">{{ __('global.select_all') }} ({{ $annexures->total() }})</a></li>
