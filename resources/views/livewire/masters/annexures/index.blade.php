...
<div>
    <div class="app-content pt-4">
        <div class="container-fluid" x-data="annexureIndexFilters({{ $this->hasActiveFilters() ? 'true' : 'false' }})">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            <thead class="table-header-custom">
                                <tr>
                                    <th>{{ __('annexures_master.document_name') }}</th>
                                    <th>{{ __('annexures_master.document_title') }}</th>
                                    <th>{{ __('annexures_master.status') }}</th>
                                    <th>{{ __('annexures_master.publish_date') }}</th>
                                    <th>{{ __('annexures_master.assigned_to') }}</th>
