                                    ...
                                    <th>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu shadow text-sm">
                                                <li><a class="dropdown-item" href="#" wire:click.prevent="selectPage">Select This Page ({{ $forms->count() }})</a></li>
                                                <li><a class="dropdown-item" href="#" wire:click.prevent="selectAll">Select All ({{ $forms->total() }})</a></li>
