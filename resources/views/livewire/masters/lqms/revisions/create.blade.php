                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="file_name" class="form-label fw-bold">{{ __('lqms_master.file_browse') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="revision" class="form-label fw-bold">{{ __('lqms_master.revision') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="change_log" class="form-label fw-bold">{{ __('lqms_master.change_log') }} <span class="text-danger">*</span></label>
