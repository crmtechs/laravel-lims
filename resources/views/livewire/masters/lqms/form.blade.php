        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">{{ __('lqms_master.file_name') }} @if(!isset($formTitle) || $formTitle !== 'Edit')<span class="text-danger">*</span>@endif</label>
                    @if(isset($formTitle) && $formTitle === 'Edit')
                        ...
                        @else
                            <div class="form-control form-control-view bg-light text-truncate">{{ __('lqms_master.no_file_uploaded') }}</div>
                        @endif
                    @else
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">{{ __('lqms_master.revision') }} <span class="text-danger">*</span></label>
                ...
                <!-- Row 2 -->
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">{{ __('lqms_master.document_name') }} <span class="text-danger">*</span></label>
                ...
                <!-- Row 3 -->
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">{{ __('lqms_master.publish_date') }} <span class="text-danger">*</span></label>
                ...
                <!-- Row 4 -->
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">{{ __('lqms_master.status') }} <span class="text-danger">*</span></label>
